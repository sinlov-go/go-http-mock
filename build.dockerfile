# This dockerfile uses extends image https://hub.docker.com/sinlov-go/go-http-mock
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/go-http-mock
ARG GO_ENV_ROOT_BUILD_BIN_NAME=go-http-mock
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/go-http-mock/main.go
...
ENTRYPOINT [ "/app/go-http-mock" ]
# CMD ["/app/go-http-mock", "--help"]